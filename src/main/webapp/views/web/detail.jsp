				...
				<aside class="col-lg-6">
					<div class="border rounded-4 mb-3 d-flex justify-content-center">
						<a data-fslightbox="mygalley" class="rounded-4" target="_blank"
							...
							<img style="max-width: 100%; max-height: 80vh; margin: auto;"
							class="rounded-4 fit" src="${product.image}" />
						</a>
					</div>
							...
							<div class="col-md-4 col-6">
								<label class="mb-2">Size</label>
									...
									<select class="form-select border border-secondary"
										...
										<option value="${list.idSize}">${list.nameSize}</option>
										</c:forEach>
									</select>
							</div>
							<div class="col-md-4 col-6">
								<label class="mb-2">Size</label>
									...
									<select class="form-select border border-secondary"
										style="height: 35px;">
										<c:forEach items="${lists}" var="list">
										<option value="${list.idColor}">${list.nameColor}</option>
										</c:forEach>
									</select>
							</div>
							<!-- col.// -->
